  ...
  return (
    <div className="relative flex items-center justify-center w-full md:h-[400px] px-4">
      ...
      >
        ...
        <Link href="/Contact">
          <button
            className="mt-3 sm:mt-4 text-sm sm:text-md px-4 sm:px-6 py-1 md:py-4 flex items-center sm:py-3 bg-[#FFAD00] 
                       rounded-md text-[#222222] font-bold shadow-lg transform skew-x-[-20deg] 
                       relative overflow-hidden z-10 hover:bg-[#222222] hover:text-[#FFAD00] duration-400"
          >
